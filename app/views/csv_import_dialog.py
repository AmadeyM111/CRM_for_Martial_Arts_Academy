...
class CSVImportDialog:
    ...
    def create_widgets(self):
        ...
        # Instructions
        instruction_label = ttk.Label(file_frame, text="1. Нажмите кнопку '📂 Выбрать файл' для выбора CSV файла")
        ...
        self.select_file_button = ttk.Button(file_select_frame, text="📂 Выбрать файл", 
                                           command=self.select_csv_file)
        self.select_file_button.pack(side=tk.RIGHT)
        
        # Add placeholder text
        self.file_entry.insert(0, "Выберите CSV файл для импорта...")
        self.file_entry.config(foreground="gray")
        
        def on_entry_click(event):
            if self.file_entry.get() == "Выберите CSV файл для импорта...":
        ...
        self.file_entry.bind('<FocusOut>', on_entry_leave)
        
        # Additional instruction
        instruction2_label = ttk.Label(file_frame, text="2. После выбора файла нажмите '✅ Проверить формат'")
        instruction2_label.pack(anchor=tk.W, pady=(5, 0))
