...
class CSVImportService:
    ...
    def validate_csv_format(self, file_path: str) -> Dict[str, Any]:
        ...
        """
        try:
            print(f"DEBUG: Opening file: {file_path}")  # Debug
            with open(file_path, 'r', encoding='utf-8') as csvfile:
                ...
                print(f"DEBUG: Detected delimiter: '{delimiter}'")  # Debug
                ...
                print(f"DEBUG: Found headers: {headers}")  # Debug
                if not headers:
                    return {
                        'valid': False,
                ...
                print(f"DEBUG: Row count: {row_count}")  # Debug
            ...
            print(f"DEBUG: Validation error: {e}")  # Debug
            return {
                'valid': False,
