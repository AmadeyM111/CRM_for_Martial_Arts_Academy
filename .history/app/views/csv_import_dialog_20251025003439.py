    ...
    def select_csv_file(self):
        ...
        try:
            ...
            if file_path:
                ...
                print(f"DEBUG: Selected file: {file_path}")  # Debug
                ...
                print("DEBUG: No file selected")  # Debug
        except Exception as e:
            print(f"DEBUG: Error selecting file: {e}")  # Debug
            messagebox.showerror("❌ Ошибка", f"Ошибка выбора файла: {e}")
    
    def validate_file(self):
        """Validate selected CSV file"""
        file_path = self.file_path_var.get().strip()
        print(f"DEBUG: Validating file: {file_path}")  # Debug
        ...
        try:
            ...
            print(f"DEBUG: Starting validation...")  # Debug
            validation = self.import_service.validate_csv_format(file_path)
            print(f"DEBUG: Validation result: {validation}")  # Debug
